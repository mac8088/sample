...
public class MyServerHandler extends ChannelInboundHandlerAdapter {
	...
	public void channelActive(ChannelHandlerContext ctx) throws Exception {
		...
		logger.info("链接报告完毕");
		// Notify client that the link has been established successfully
	...
	public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
		// Receive MSG message {与上一章节相比，此处已经不需要自己进行解码}
		logger.info(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date()) + " 服务端接收到消息：" + msg);
		// Notification client chain message sent successfully
