package net.atos.sample.kafka.report.controller;
...
import net.atos.sample.kafka.report.config.Constants;
import net.atos.sample.kafka.report.model.ReportData;
